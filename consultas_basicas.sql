...
INSERT INTO sales VALUES (1010, '2024-03-20', 205, 304, 'Teclado Mecánico',   'Accesorios',  4,   95.00,  380.00);
	...
	-- Autor: Sofia Calabria
	-- Fecha: 07/07/2026
	-- ══════════════════════════════════════════
	-- Consulta 1: Exploración general de la tabla sales.
	-- El * se utiliza si necesitas ver cada rincón de una tabla (osea toda la tabla). Si no la utilizas, nada mas traeria las columnas que le estas pidiendo.
	SELECT * FROM sales;
